...
button_clear  =Button(root, text="Clear", padx=120, pady=25, command=button_clear)

button_subtract  =Button(root, text="-", padx=39, pady=25, command=button_sub)
button_multiply  =Button(root, text="x", padx=39, pady=25, command=button_mul)
